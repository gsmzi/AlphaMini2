...
- Wann immer relevante Änderungen an den nutzer- und schülerrelevanten Dateien vorgenommen werden (z. B. `.bat`-Skripte, `ANLEITUNG.md`, `UNTERRICHTSMATERIAL_5_KLASSE.md`, `Schülerversion/`, `1_Roboter_einstellen.bat`, `2_Robotersoftware_aktualisieren.bat`, `.apk`):
