...
- Wann immer relevante Änderungen an den nutzer- und schülerrelevanten Dateien vorgenommen werden (z. B. `.bat`-Skripte, `ANLEITUNG.md`, `UNTERRICHTSMATERIAL_5_KLASSE.md`, `alphablock/`, `alphablock_server.py`, `.apk`):
